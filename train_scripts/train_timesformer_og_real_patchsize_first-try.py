    ...
    def __getitem__(self, idx):
        if self.xyxys is not None:
            ...
            if self.transform:
                ...
                label=F.interpolate(label.unsqueeze(0),(4,4)).squeeze(0)
...
class RegressionPLModel(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        for i, (x1, y1, x2, y2) in enumerate(xyxys):
            ...
            size=(CFG.size, CFG.size),  # Match CFG.size
            mode='bilinear'
...
for fid in fragments:
    ...
    run_slug=f'test-originaldatasplit-tilesize64'

    valid_mask_gt = cv2.imread(CFG.comp_dataset_path + f"train_scrolls/{fragment_id}/{fragment_id}_inklabels.png", 0)

    pred_shape=valid_mask_gt.shape
    train_ids = [
'20231210121321','20231022170901',
'20231106155351','20231005123336',
'20230820203112','20230826170124',
'20230702185753','20230522215721',
'20230531193658','20230903193206',
'20230902141231','20231007101615',
'20230929220926','recto',
'20231016151000','20231012184423',
'20231031143850'
    ]
    train_images, train_masks, valid_images, valid_masks, valid_xyxys = get_train_valid_dataset(train_ids)
    ...
    wandb_logger = WandbLogger(project="vesivus",name=run_slug+f'test')
