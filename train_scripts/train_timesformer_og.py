...
class CFG:
    ...
    tile_size = 256
    stride = tile_size // 8
    train_batch_size = 120 # 32
    valid_batch_size = 75 #train_batch_size
                ...
                if (fragment_id==CFG.valid_id) or (not np.all(mask[a:a + CFG.tile_size, b:b + CFG.tile_size]<0.05)):
                    for yi in range(0,CFG.tile_size,CFG.size):
                        for xi in range(0,CFG.tile_size,CFG.size):
                            ...
                            if fragment_id==CFG.valid_id:
                                #print(f"{fragment_id} is in validation set")
...
fragments=[ #'20231210121321',
#'verso','20230901184804',
'20230531193658','20231007101615',
'20231005123333',
'20230522215721',
...
for fid in fragments:
    ...
    wandb_logger = WandbLogger(project="vesivus",name=run_slug+f'timesformer_fixdataset-2')
